...
const username = 'admin@gbtec.com';
const password = 'Test1234567!';
const baseURL = 'pe-2113.ansible';
...
describe('Log into de Execution App', function () {
  ...
  it('Access to URL & Login', function () {
    ...
    // }).as('ExecutionProcessesSection');

    cy.visit(
      `https://${baseURL}.gbtecdev.net/process-execution`
    ...
    cy.get('bic-process-execution-root').should('exist')
    // cy.wait("@ExecutionProcessesSection")
  });
});